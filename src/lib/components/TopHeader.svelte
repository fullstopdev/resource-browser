            ...
            <div class="min-w-0 text-center sm:text-left">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-300 mt-1 truncate flex items-center gap-2 -translate-y-0.5">
                ...
                <span class="flex items-center">
                  ...
                  {#if deprecated}
                    <span class="ml-3 inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-orange-50 dark:bg-orange-900/20 border-2 border-orange-200 dark:border-orange-700 text-sm font-semibold text-orange-700 dark:text-orange-300" title={deprecatedSince ? `Deprecated since ${deprecatedSince}` : ''}>
                      ...
                      <span>DEPRECATED{#if deprecatedSince}<span class="ml-2 text-xs font-normal text-orange-600 dark:text-orange-400">since {deprecatedSince}</span>{/if}</span>
                    </span>
                  {/if}
                </span>
              </p>
