...
<p class="p-5 text-sm text-center select-none {home ? 'text-gray-400' : 'text-gray-800 dark:text-gray-300 dark:bg-gray-800'}">
	Created by
	<a 
	...
	<a
		...
		target="_blank">
		<svg
			class="w-5 h-5 {home ? 'text-gray-300' : 'text-gray-500 dark:text-gray-400'} inline-flex"
			fill="currentColor"
			viewBox="0 0 25 25"
